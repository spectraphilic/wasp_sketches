...
/* Edited for Waspmote by John Hulth, 2016-05-10
...
void setup() 
{
  ...
  PWR.setSensorPower(SENS_3V3,SENS_ON); // Sets the 3,3V switch OFF
  ...
  { // If the read succeeded, print the ID:
    ...
    PWR.setSensorPower(SENS_3V3,SENS_OFF); // Sets the 3,3V switch OFF
      ...
      //USB.println("ID: 0x" + String(therm.getIDH(), HEX) + String(therm.getIDL(), HEX));
  }
}
