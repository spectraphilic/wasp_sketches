...
void loop()
{
  ...
  // "00:00:00:00", RTC_ABSOLUTE, RTC_ALM1_MODE5" -> Wake-up every minute
  ...
  if(intFlag & RTC_INT)
  {
    ...
    Utils.long2array(epoch, node_ID); // Gets the number ‘1356’ into the string
    // Set the epoch timestamp into Waspmote ID
    frame.setID(node_ID); 
