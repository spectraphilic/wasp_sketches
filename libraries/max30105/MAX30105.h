...
class MAX30105 {
 public: 
  ...
  boolean begin(WaspI2C &wirePort = I2C, uint32_t i2cSpeed = I2C_SPEED_STANDARD, uint8_t i2caddr = MAX30105_ADDRESS);
 ...
 private:
  WaspI2C *_i2cPort; //The generic connection to user's chosen I2C hardware
  uint8_t _i2caddr;
